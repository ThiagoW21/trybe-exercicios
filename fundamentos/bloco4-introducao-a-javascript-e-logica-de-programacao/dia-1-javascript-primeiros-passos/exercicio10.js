...
const valorVenda = parseFloat(readlineSync.question('Valor de venda: '));
const custoProd = parseFloat(readlineSync.question('Custo do produto: '));
if (valorVenda === 0 || custoProd === 0) {
  console.log("Erro! Valores inválidos.")
}

else {
  let custoComImposto = custoProd * 1.20;
  let lucro = (valorVenda - custoComImposto) * 1000;
  console.log("Lucro de R$%f", lucro)
}
